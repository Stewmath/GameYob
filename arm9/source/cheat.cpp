// Contains a copy of the c++ cpu core which can execute a single instruction 
// and return.
// I had trouble linking c++ with assembly, rather than plain c.
// Used for unfinished opcodes in the assembly core.
//
#include "gbcpu.h"
#include "mmu.h"
#include "gameboy.h"
...
// stuff defined in gbcpu.cpp which otherwise shouldn't be public
...
void storevars(int locaf, int locbc, int locde, int lochl)
{
	af.w = locaf;
	bc.w = locbc;
	de.w = locde;
