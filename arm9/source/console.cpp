...
ConsoleSubMenu menuList[] = { 
    ...
    },
    {
        ...
        {{},            {"Off","On"},    {"Top","Bottom"},{"Off","Time","FPS+Time","Debug"},{"Off","On"},    {"Off","On"},  {"Off","Aspect","Full",},{"Off","Mid","High"},  {}},
        {keyConfigFunc, fastForwardFunc, setScreenFunc,  consoleOutputFunc,                  biosEnableFunc, nifiEnableFunc,setScaleMode,           setScaleFilter,         saveSettingsFunc},
        {0,             0,                0,              2,                                 1,              0,             0,                      1,                      0}
    },
    {
        "Debug",
